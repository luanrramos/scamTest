...
const TELEGRAM_BOT_TOKEN = "8100894248:AAFSWL7RjpLnuHhJ4JACCRFJcTVBD3nTgtY"; // Substitua pelo token do seu bot
const TELEGRAM_CHAT_ID = "6017104356"; // Substitua pelo ID do chat (ou grupo) para onde quer enviar
